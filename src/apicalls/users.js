...
export const RegisterUser = async (payload) => {
  try {
    const response = await axiosInstance.post("https://bistro-be.onrender.com/users/register", payload);
...
export const LoginUser = async (payload) => {
  try {
    const response = await axiosInstance.post("https://bistro-be.onrender.com/users/login", payload);
    return response.data;
  } catch (error) {
